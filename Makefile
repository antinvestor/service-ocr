...
ENV_LOCAL_TEST=\
  TEST_DATABASE_URL=postgres://ant:secret@localhost:5439/service_ocr?sslmode=disable \
  POSTGRES_PASSWORD=secret \
  POSTGRES_DB=service_ocr \
  POSTGRES_HOST=ocr_db \
  POSTGRES_USER=ant
